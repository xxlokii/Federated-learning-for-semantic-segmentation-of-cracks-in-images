...
class UNet(nn.Module):
    ...
    def forward(self, x):
        # down sampling
        R1 = self.cov1(x)
        R2 = self.cov2(self.encoder1(R1))
        R3 = self.cov3(self.encoder2(R2))
        R4 = self.cov4(self.encoder3(R3))
        Y1 = self.cov5(self.encoder4(R4))

        # up sampling
        O1 = self.cov6(self.decoder1(Y1, R4))
        O2 = self.cov7(self.decoder2(O1, R3))
        O3 = self.cov8(self.decoder3(O2, R2))
        O4 = self.cov9(self.decoder4(O3, R1))
